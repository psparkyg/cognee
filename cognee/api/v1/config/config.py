...
class config:
    ...
    @staticmethod
    def _update_config(config_obj, config_dict: dict): #Added _update_config() helper function
    ...
    def set_llm_config(config_dict: dict):
        ...
        return config._update_config(get_llm_config(), config_dict) #set_llm_config() setter function fixed
    ...
    def set_relational_db_config(config_dict: dict):
        ...
        return config._update_config(get_relational_config(), config_dict) #set_relational_db_config() setter function fixed.

    @staticmethod
    def set_migration_db_config(config_dict: dict):
        """Updates the relational db config with values from config_dict."""
        return config._update_config(get_migration_config(), config_dict) #set_migration_db_config() setter function fixed.

    @staticmethod
    def set_graph_db_config(config_dict: dict) -> None:
        """Updates the graph db config with values from config_dict."""
        return config._update_config(get_graph_config(), config_dict) #set_graph_db_config() setter function fixed.

    @staticmethod
    def set_vector_db_config(config_dict: dict):
        """Updates the vector db config with values from config_dict."""
        return config._update_config(get_vectordb_config(), config_dict) #set_vector_db_config() setter function fixed.
    ...
    def set_translation_config(config_dict: dict):
        ...
        return config._update_config(get_translation_config(), config_dict) #set_translaton_config() setter function fixed.

    def set(key: str, value):
        """Generic setter that maps configuration keys to their specific setter methods. This enables CLI commands like 'cognee config set llm_api_key <value>'."""
